...
var _fetchJsonp = __webpack_require__(117);
...
var getCity = function getCity(city) {
	return { type: GET_CITY, city: city };
};

var GET_WEATHER = 'GET_WEATHER';
var getWeather = function getWeather(data) {
	return { type: GET_WEATHER, data: data };
};

var FETCHING = 'FETCHING';
var fetchingWeather = function fetchingWeather(fetching) {
	return { type: FETCHING, fetching: fetching };
};

var fetchWeather = function fetchWeather(city) {
	return function (dispatch) {
		dispatch(fetchingWeather(true));
		return (0, _fetchJsonp2.default)('https://api.asilu.com/weather/?city=' + city).then(function (response) {
			...
			return dispatch(fetchingWeather(false));
		});
	};
};
...
var city = function city() {
	var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : (0, _immutable.Map)({ city: '南宁' });
	var action = arguments[1];

	switch (action.type) {
		case GET_CITY:
			return state.update('city', function () {
				return action.city;
			});
		default:
			return state;
...
var fetchData = function fetchData() {
	var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : (0, _immutable.Map)({ fetching: false });
	var action = arguments[1];

	switch (action.type) {
		case FETCHING:
			return state.update('fetching', function () {
...
var weatherData = function weatherData() {
	var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : (0, _immutable.Map)({ data: {} });
	var action = arguments[1];
...
// store
var store = (0, _redux.createStore)((0, _redux.combineReducers)({ city: city, fetchData: fetchData, weatherData: weatherData }), (0, _redux.compose)((0, _redux.applyMiddleware)(_reduxThunk2.default), window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__()));

// components
var SelectCity = function SelectCity(_ref) {
	var fetchWeather = _ref.fetchWeather,
	...
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement('input', { type: 'text', value: city, className: 'form-control', placeholder: '\u8F93\u5165\u57CE\u5E02', ref: function ref(node) {
					input = node;
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(
					...
					{ className: 'btn btn-default', type: 'button', onClick: function onClick() {
							return fetchWeather(input.value);
						} },
					fetchData ? "查询中..." : "查询"
				)
			)
...
var WeatherItem = function WeatherItem(_ref2) {
	var date = _ref2.date,
...
var WeatherInfo = function WeatherInfo(_ref3) {
	var city = _ref3.city,
	    pm25 = _ref3.pm25,
	    date = _ref3.date,
	...
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(
				'div',
				{ className: 'row' },
				weather instanceof Array && weather.map(function (item, i) {
					return _react2.default.createElement(WeatherItem, _extends({}, item, { key: i }));
				})
			)
		)
	);
...
var App = (_dec = (0, _reactRedux.connect)(function (state) {
	...
	return (0, _redux.bindActionCreators)({ fetchWeather: fetchWeather, getCity: getCity, fetchingWeather: fetchingWeather }, dispatch);
	...
	_createClass(App, [{
		...
		value: function render() {
			var _props = this.props,
			    city = _props.city,
			    fetchWeather = _props.fetchWeather,
			    fetchData = _props.fetchData,
			    weatherData = _props.weatherData,
			    getCity = _props.getCity;

			return _react2.default.createElement(
				'div',
				{ className: 'container', style: { marginTop: "20px" } },
				_react2.default.createElement(SelectCity, {
					fetchWeather: fetchWeather,
					getCity: getCity,
					city: city.get('city'),
					fetchData: fetchData.get('fetching') }),
				_react2.default.createElement(WeatherInfo, weatherData.get('data'))
			);
		}
	}]);
